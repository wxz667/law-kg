...
def main() -> int:
    parser = argparse.ArgumentParser(description="Relation classifier dataset/train/predict utilities.")
    ...
    predict_parser.add_argument("--text", required=True, nargs="+")
    ...
    if args.command == "train":
        ...
        print(model_path)
        return 0
    results = predict(args.text, Path(args.model_dir) if args.model_dir else None)
