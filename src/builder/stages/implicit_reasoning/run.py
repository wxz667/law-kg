...
from ...pipeline.incremental import owner_document_by_node, replace_implicit_reasoning_outputs
...
def run(
    ...
    if active_sources:
        graph_bundle = replace_implicit_reasoning_outputs(graph_bundle, active_source_ids=active_sources)
