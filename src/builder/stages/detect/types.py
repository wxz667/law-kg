...
class DocumentScanResult:
    ...
    profiling: DetectProfiling = field(default_factory=DetectProfiling)


@dataclass(frozen=True)
class DetectContext(ReferenceGraphContext):
