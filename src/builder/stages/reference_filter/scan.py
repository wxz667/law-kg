...
from .types import DocumentScanResult, ReferenceFilterContext
...
def resolve_document_worker_count(runtime: Any, document_count: int) -> int:
    config_loader = getattr(runtime, "reference_filter_config", None)
...
def target_category_for_node_id(target_node_id: str, context: ReferenceFilterContext) -> str:
